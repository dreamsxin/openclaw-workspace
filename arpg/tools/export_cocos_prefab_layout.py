...
PREFABS = [
    ...
    ("英雄技能提示", "Prefab/HeroPanel/HeroSkillTips"),
    ("英雄神器", "Prefab/HeroPanel/HeroShenQiPre"),
    ("英雄神器升级", "Prefab/HeroPanel/HeroShenQiUpgradePre"),
    ("英雄水晶获取", "Prefab/HeroPanel/HeroGetShuiJingPre"),
    ("英雄水晶升级", "Prefab/HeroPanel/HeroShuiJingUpLevelPre"),
    ("英雄水晶更换", "Prefab/HeroPanel/HeroShuiJingChangePre"),
    ("英雄水晶重置", "Prefab/HeroPanel/HeroShuiJingResetPre"),
    ("英雄水晶提示", "Prefab/BagPanel/HeroShuiJingTipsPre"),
    ...
    ("英雄共鸣信息", "Prefab/HeroListPanel/HeroLevelSharedHeroInfoPre"),
    ("英雄共鸣移除", "Prefab/HeroListPanel/HeroLevelSharedRemovePre"),
    ("英雄共鸣成功", "Prefab/HeroListPanel/HeroLevelSharedSuccessPre"),
    ("英雄共鸣确认", "Prefab/alert/AlertHeroLevelSharedPre"),
    ("英魂殿", "Prefab/HeroPalace/HeroPalacePre"),
    ("英魂合成", "Prefab/HeroPalace/HeroPalaceSynthesizePre"),
    ("英魂英雄分解", "Prefab/HeroPalace/HeroPalaceHeroDecomposePre"),
    ("英魂英雄分解预览", "Prefab/HeroPalace/HeroPalaceHeroDecomposePreviewPre"),
    ("英魂碎片分解", "Prefab/HeroPalace/HeroPalaceHeroShardDecomposePre"),
    ("英魂碎片分解预览", "Prefab/HeroPalace/HeroShardDecomposePreviewPre"),
    ("英魂重生", "Prefab/HeroPalace/HeroPaleceRebirthPre"),
    ("英魂回退", "Prefab/HeroPalace/HeroPaleceGoBackPre"),
    ("英魂回退确认", "Prefab/HeroPalace/HeroPaleceGoBackConfirmationPre"),
    ("英魂置换", "Prefab/HeroPalace/HeroPalaceReplacementPre"),
    ("英魂置换成功", "Prefab/HeroPalace/HeroPalaceReplacementSuccessPre"),
    ("英魂选择材料", "Prefab/HeroPalace/HeroPaleceSelectMaterialsPre"),
    ("英魂详情", "Prefab/HeroPalace/HeroPalaceDetailPre"),
    ("英雄阵容", "Prefab/HeroXZPrefab/HeroNormalarrayPre"),
    ("英雄阵容克制", "Prefab/HeroXZPrefab/HeroFormationrestraintPre"),
    ("英雄升星", "Prefab/HeroXZPrefab/HeroStarPre"),
    ("英雄星位", "Prefab/HeroXZPrefab/StaritemPre"),
    ("英雄星位技能", "Prefab/HeroXZPrefab/StarSkillPre"),
    ("英雄星位升级", "Prefab/HeroXZPrefab/StarUpPre"),
    ("英雄星位技能升级", "Prefab/HeroXZPrefab/skillUpPre"),
    ("背包", "Prefab/BagPanel/BagPre"),
    ("背包格子面板", "Prefab/BagPanel/GridBoxPre"),
    ("背包格子", "Prefab/BagPanel/GridBoxItemPre"),
    ("背包出售装备", "Prefab/BagPanel/BagSellEquipPre"),
    ("背包出售物品", "Prefab/BagPanel/sellGridPre"),
    ("背包批量使用", "Prefab/BagPanel/piliangTipsPre"),
    ("背包获取途径", "Prefab/BagPanel/huoquTipsPre"),
    ("背包获取途径项", "Prefab/BagPanel/huoquItemPre"),
    ("背包合成提示", "Prefab/BagPanel/hechengTipsPre"),
    ("背包格子提示", "Prefab/BagPanel/GridTipsPre"),
    ("背包符文提示", "Prefab/BagPanel/fuwenTipsPre"),
    ("背包购买格子", "Prefab/BagPanel/buyGridPre"),
    ("神器图鉴", "Prefab/HeroPanel/ShenQiHandBookPre"),
