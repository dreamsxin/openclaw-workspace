...
| T030 | Build first Godot UI layout reference screens | in progress | Godot prototype now has a `UI Ref` selector and scaled RectTransform wireframe preview for startup/root UI sources; actual rebuilt Control scenes still pending |
