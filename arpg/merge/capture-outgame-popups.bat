...
set "CAPTURE_DIR=%ROOT%reverse-output\outgame-captures"
...
pushd "%ROOT%" >nul
"%GODOT%" --path "%PROJECT%" --resolution 540x960 --quit-after 480 %* -- --restored-startup --auto-capture-outgame-popups --startup-capture-dir="%CAPTURE_DIR%"
...
echo.
echo UIOutGame captures written to:
echo   %CAPTURE_DIR%
dir /b "%CAPTURE_DIR%"
