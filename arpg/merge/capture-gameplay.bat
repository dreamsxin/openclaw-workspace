...
set "CAPTURE_DIR=%ROOT%reverse-output\gameplay-captures"
...
pushd "%ROOT%" >nul
"%GODOT%" --path "%PROJECT%" --resolution 540x960 --quit-after 420 %* -- --restored-startup --auto-enter-ingame --startup-capture-dir="%CAPTURE_DIR%"
...
echo.
echo Gameplay captures written to:
echo   %CAPTURE_DIR%
dir /b "%CAPTURE_DIR%"
